...
<body>
    ...
    <form action="loginUtente.php" class="login-box mx-auto" method="post">
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Email or Username</label>
            <input type="text" class="form-control" id="emailUser" name="emailUser" aria-describedby="emailHelp" required />
        ...
        <div class="mb-3 form-check pl-0">
            <a href="registrazione-Utente.php">Non ti sei registrato?Clicca qui</a>
        </div>
        <div class="btn-box">
